...
**Verification depth scales with `asvs_level`** (see @/Users/huaxinzhang/Desktop/trifles/interactive-discuss-iteration/.claude/gsd-core/references/security-asvs-levels.md for full definitions):
