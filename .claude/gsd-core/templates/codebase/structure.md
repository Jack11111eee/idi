...
- Usage: Reference from command with `@/Users/huaxinzhang/Desktop/trifles/interactive-discuss-iteration/.claude/gsd-core/workflows/{name}.md`
...
**gsd-core/**
- Purpose: Resources installed to /Users/huaxinzhang/Desktop/trifles/interactive-discuss-iteration/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/huaxinzhang/Desktop/trifles/interactive-discuss-iteration/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
