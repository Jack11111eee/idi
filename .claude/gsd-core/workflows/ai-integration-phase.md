...
<required_reading>
@/Users/huaxinzhang/Desktop/trifles/interactive-discuss-iteration/.claude/gsd-core/references/ai-frameworks.md
@/Users/huaxinzhang/Desktop/trifles/interactive-discuss-iteration/.claude/gsd-core/references/ai-evals.md
</required_reading>
...
```markdown
Read /Users/huaxinzhang/Desktop/trifles/interactive-discuss-iteration/.claude/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/Users/huaxinzhang/Desktop/trifles/interactive-discuss-iteration/.claude/gsd-core/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /Users/huaxinzhang/Desktop/trifles/interactive-discuss-iteration/.claude/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /Users/huaxinzhang/Desktop/trifles/interactive-discuss-iteration/.claude/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /Users/huaxinzhang/Desktop/trifles/interactive-discuss-iteration/.claude/agents/gsd-eval-planner.md for instructions.
