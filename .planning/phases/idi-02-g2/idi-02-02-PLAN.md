...
<task type="auto">
  ...
  <behavior>
    ...
    - 用例 2:POST /api/rounds/{n}/annotations(phase3 当前轮):建条目落盘(status=pending、type=comment)→ 返回条目;对非当前轮轮号 → 409;对非 phase3 项目 → 409;busy → 409
