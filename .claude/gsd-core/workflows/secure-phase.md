...
```
Agent(
  prompt="Read /Users/huaxinzhang/Desktop/trifles/interactive-discuss-iteration/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/huaxinzhang/Desktop/trifles/interactive-discuss-iteration/.claude/gsd-core/templates/SECURITY.md`
