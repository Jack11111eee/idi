...
- [x] **Phase 3: 授权、自检与终点——G3、档位、使命完成归档** - G3 四处校验与确认词、DESIGN.md.tmp 原子落盘、宽松/严格自检循环与 D-22 残余裁决、崩溃自愈、完成态只读归档 (completed 2026-09-13)
...
- [x] idi-03-01-PLAN.md — 数据脊柱:g3.py(四查+授权写入)+ checks.py(tier/裁决/PASS 磁盘签名)+ grammar.py 增量解析器(档位行/问题分级/纯 P2/待裁决扫描)

**Wave 2** *(blocked on Wave 1 completion)*

- [x] idi-03-02-PLAN.md — 后端全层:authorize/set_tier/verdict/三 start 流水线(tmp 原子改名+两跳自动循环+抛问截存)+ prompt 三族 + authorize/tier/verdict/post-mortem 五路由(writing/start/repair 三条 202 归 idi-03-03)+ snapshot 扩展
...
- [x] idi-03-04-PLAN.md — 前端阶段 3-5 视图:G3 确认词模态+拒绝转批注、档位模态、报告视图与三 mode 裁决控件、使命完成欢呼+只读归档
...
| 3. 授权、自检与终点——G3、档位、使命完成归档 | 5/5 | Complete    | 2026-09-13 |
